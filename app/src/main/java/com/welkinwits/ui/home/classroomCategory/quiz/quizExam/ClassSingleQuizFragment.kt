package com.welkinwits.ui.home.classroomCategory.quiz.quizExam
...
import com.welkinwits.databinding.FragmentClassSingleQuizBinding
import com.welkinwits.model.QuestionModelData
import com.welkinwits.service.request.quiz.PostQuizAnswerRequest
import com.welkinwits.service.request.quiz.SubmitDatum
...
class ClassSingleQuizFragment : BaseFragment(R.layout.fragment_class_single_quiz) {
    ...
    private fun showAlertDialogButtonClicked(mContext:Context) {
        val activity = mContext as? Activity ?: return // Ensure mContext is an Activity
        if (activity.isFinishing) return // Check if the activity is finishing
