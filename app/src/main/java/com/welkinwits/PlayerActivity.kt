...
import com.welkinwits.databinding.ActivityPlayerBinding
...
class PlayerActivity : AppCompatActivity(), Player.Listener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (urlString?.contains("youtube", true) == true) {
            Log.d("PlayerActivityURL", "YouTube: "+urlString)
...
// Check if there are at least two elements after splitting
            if (split.size >= 2) {
                ...
                // Handle case where split array doesn't have at least two elements
                Toast.makeText(this, "Invalid YouTube URL format", Toast.LENGTH_SHORT).show()
                Log.e("PlayerActivityURL", "Invalid YouTube URL format: $urlString")
                // You might want to display an error message to the user or handle this case appropriately
            }
