package com.witsclassdevelopment.ui.home.scholarship.register.exam
...
import com.witsclassdevelopment.service.respose.homeBanner.scholarship.scholarshipCreateExam.scholarshipUpdateEnrollment.scholarshipStartExam.Question

class ScholarshipStartExamAdapter(var mContext:Context) :
    CardSliderAdapter<ScholarshipStartExamAdapter.FuturePlusSliderViewHolder>() {
    private var mList: ArrayList<Question> ?= null
    private var mAdapter: ScholarshipSingleQuestionOptionAdapter? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FuturePlusSliderViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.layout_scholarship_start_exam_single_item, parent, false)
    ...
    private fun configureRecyclerView(
       ...
       /* val answerListModel: ArrayList<QuestionModelData> = ArrayList()
        ...
        mAdapter = options?.let { ScholarshipSingleQuestionOptionAdapter(it) }
