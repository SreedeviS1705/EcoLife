package com.witsclassdevelopment.ui.home.feePayment.feePaymentModeOfStudy.modeOfPayment.feeStructure.partPayment.partPaymentOrderBill
...
import com.witsclassdevelopment.databinding.FragmentPartPaymentOrderBillBinding
import com.witsclassdevelopment.ui.base.BaseFragment
import com.witsclassdevelopment.ui.home.feePayment.feePaymentModeOfStudy.modeOfPayment.feeStructure.orderBill.PaymentInitViewModel
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class PartPaymentOrderBillFragment : BaseFragment(R.layout.fragment_part_payment_order_bill) {
    ...
    private var binding: FragmentPartPaymentOrderBillBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentPartPaymentOrderBillBinding.bind(view)
        ...
        val partPaymentId = arguments?.getString("partPaymentId")
        ...
        viewModel.createOrder(packageId, enrollmentId, partPaymentId)
