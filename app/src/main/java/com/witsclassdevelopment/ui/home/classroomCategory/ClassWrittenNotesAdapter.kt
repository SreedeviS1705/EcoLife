...
class ClassWrittenNotesAdapter(var writtenNotes: ArrayList<String>?, var mContext: Context) :
    CardSliderAdapter<ClassWrittenNotesAdapter.FuturePlusSliderViewHolder>() {
