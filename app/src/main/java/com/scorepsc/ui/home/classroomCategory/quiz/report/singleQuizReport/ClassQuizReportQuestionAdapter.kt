package com.scorepsc.ui.home.classroomCategory.quiz.report.singleQuizReport
...
import com.scorepsc.service.respose.homeBanner.quiz.report.singleQuizReport.Report
import com.scorepsc.ui.home.classroomCategory.quiz.quizExam.SingleQuestionOptionReportAdapter

class ClassQuizReportQuestionAdapter(var mContext:Context) :
    CardSliderAdapter<ClassQuizReportQuestionAdapter.FuturePlusSliderViewHolder>() {
